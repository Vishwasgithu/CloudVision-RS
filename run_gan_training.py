"""
evaluate_gan.py
Evaluates the trained GAN on test patches completely independently.
Shows: cloudy input | cloud mask | generated output | ground truth
...
# ═══════════════════════════════════════════════════════
# SELF-CONTAINED DATASET (Bypasses Circular Import)
# ═══════════════════════════════════════════════════════
...
for ax, title in zip(
    axes[0],
    ["Cloudy Input", "Generated (Cloud-Free)", "Ground Truth", "Difference Map"],
):
